...
function boolFilterPrice(){
   ...
   document.getElementById('200-300').onclick = function(e){
                if (this.checked){
					alert("HIHIhi");
                    $('.img_product').html("<img src='img/bia2.jpg' alt='...' />");
                }
                else{
