<div class="container-fluid">
    <form action="modules/nguoidung/xuly.php" method="post" enctype="multipart/form-data">
        ...
        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#xoa<?php echo $dong['id_user'] ?>">Xóa</button>
            
        <div class="modal fade" id="xoa<?php echo $dong['id_user'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
